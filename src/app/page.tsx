...
export default function App() {
  ...
  const applyBulk = () => {
    ...
    setSelected([]);
    setShowModal(false);
    setInputs({ title: "", goals: "", homework: "" }); // ✅ يفرغ القيم بعد كل تعبئة
  };
  ...
  return (
    ...
    >
      {/* ✅ الترويسة */}
      <header className="text-center py-6 bg-white/80 shadow-sm backdrop-blur rounded-b-3xl border-b border-gray-200">
